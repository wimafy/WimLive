    ...
    $.fn.countdownClock = function(options) {
        ...
        self.renderTemplate = function() {
            ...
            // For years, months, days, hours, minutes, seconds; create the strings.
                ...
                html += "<span id='" + self.options.id + "y' style='visibility: hidden; position: absolute;'> <span class='years'></span> Years </span>";
            
            
                html += "<span id='" + self.options.id + "mon' style='visibility: hidden; position: absolute;'><span class='months'></span> Months </span>";
           
                html += "<span id='" + self.options.id + "d' style='visibility: hidden; position: absolute;'><span class='days'></span> Days </span>";
            
                html += "<span id='" + self.options.id + "h' style='visibility: hidden; position: absolute;'><span class='hours'></span> Hours </span>";
            
                html += "<span id='" + self.options.id + "min' style='visibility: hidden; position: absolute;'><span class='minutes'></span> Minutes </span>";
           
                html += "<span id='" + self.options.id + "s' style='visibility: hidden; position: absolute;'><span class='seconds'></span> Seconds </span>";
            
                //is included in above stuff but i added it in for fun!!!
                html += "<span id='" + self.options.id + "live' style='visibility: hidden; position: absolute;'>Event is live </span>";
        ...
        self.updateClock = function() {
            ...
            */
            ...
            //console.log(clockValues.years);
            
            
            if ( clockValues.years > 0) {
                console.log("show years");
                document.getElementById(self.options.id + 'y').style.visibility = "visible";
                document.getElementById(self.options.id + 'y').style.position = "relative";
            }else if( clockValues.months > 0) {
                console.log("show months");
                document.getElementById(self.options.id + 'y').style.visibility = "hidden";
                document.getElementById(self.options.id + 'y').style.position = "absolute";
                document.getElementById(self.options.id + 'mon').style.visibility = "visible";
                document.getElementById(self.options.id + 'mon').style.position = "relative";
            }else if( clockValues.days > 0) {
                console.log("show days");
                document.getElementById(self.options.id + 'mon').style.visibility = "hidden";
                document.getElementById(self.options.id + 'mon').style.position = "absolute";
                document.getElementById(self.options.id + 'd').style.visibility = "visible";
                document.getElementById(self.options.id + 'd').style.position = "relative";
            }else if( clockValues.hours > 0) {
                console.log("show hours");
                document.getElementById(self.options.id + 'd').style.visibility = "hidden";
                document.getElementById(self.options.id + 'd').style.position = "absolute";
                document.getElementById(self.options.id + 'h').style.visibility = "visible";
                document.getElementById(self.options.id + 'h').style.position = "relative";
            }else if( clockValues.minutes > 0) {
                console.log("show minutes");
                document.getElementById(self.options.id + 'h').style.visibility = "hidden";
                document.getElementById(self.options.id + 'h').style.position = "absolute";
                document.getElementById(self.options.id + 'min').style.visibility = "visible";
                document.getElementById(self.options.id + 'min').style.position = "relative";
            }else if( clockValues.seconds > 0) {
                console.log("one minute");
                document.getElementById(self.options.id + 'min').style.visibility = "hidden";
                document.getElementById(self.options.id + 'min').style.position = "absolute";
                document.getElementById(self.options.id + 's').style.visibility = "visible";
                document.getElementById(self.options.id + 's').style.position = "relative";
            }else{
                console.log("event is live"); 
                document.getElementById(self.options.id + 's').style.visibility = "hidden";
                document.getElementById(self.options.id + 's').style.position = "absolute";
                document.getElementById(self.options.id + 'live').style.visibility = "visible";
                document.getElementById(self.options.id + 'live').style.position = "relative";
            }
