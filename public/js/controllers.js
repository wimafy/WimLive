...
wimControllers.controller('ProfileController', ['$scope', '$log', '$location', 'userService', 'profileService', '$http', function($scope, $log, $location, userService, profileService, $http){
 ...
 $scope.initializeClock = function(id, clockID, endtime) {
  ...
  $scope.customers=  [
            { name:'John Smith', city:'Phoenix', id: 'november 10 2016 17:55:59 GMT-0500'},
            { name:'John Doe', city:'New York', id: 'november 10 2016 17:55:59 GMT-0500'},
            { name:'Jane Doe', city:'San Francisco', id: 'november 10 2016 17:55:59 GMT-0500'}
          ];
