<html lang="en" ng-app="wim">
    <head>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCyB6K1CFUQ1RwVJ-nyXxd6W0rfiIBe12Q&libraries=places&callback=initAutocomplete" type="text/javascript"></script>
